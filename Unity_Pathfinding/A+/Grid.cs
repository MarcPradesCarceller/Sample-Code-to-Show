...
public class Grid : MonoBehaviour
{
    ...
    //Blur matrix to avoid the AI to go always too colose to doors
    ...
    void OnDrawGizmos()
    {
        ...
        if (grid != null && displayGridGizmos)
        {
            foreach (Node n in grid)
            {
                ...
                Gizmos.color = Color.Lerp(Color.white, Color.magenta, Mathf.InverseLerp(penaltyMin, penaltyMax, n.movementPenalty));
